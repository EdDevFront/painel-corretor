...
const PLAN_ACCORDIONS = [
  { id: "area", title: "Ãrea de ComercializaÃ§Ã£o / UtilizaÃ§Ã£o", desc: "DisponÃ­vel para toda a RegiÃ£o Metropolitana e capitais associadas." },
  { id: "cancel", title: "Cancelamento do Contrato", desc: "Cancelamento sem carÃªncia ou multas rescisÃ³rias em atÃ© 30 dias apÃ³s a assinatura formal." },
  { id: "carencias", title: "CarÃªncias", desc: "UrgÃªncia e emergÃªncia: 24h. Consultas e exames simples: 30 dias. Procedimentos complexos: 180 dias. Parto: 300 dias." },
  { id: "composition", title: "ComposiÃ§Ã£o / Quem Pode Aderir", desc: "SÃ³cios, administradores e funcionÃ¡rios com vÃ­nculo CLT ativo." },
  { id: "docs", title: "Documentos NecessÃ¡rios", desc: "RG, CPF, Comprovante de ResidÃªncia e Contrato Social ou Certificado de MEI." },
  { id: "pay", title: "Forma de Pagamento", desc: "Boleto bancÃ¡rio mensal com vencimento selecionado na assinatura da proposta." },
  { id: "prod", title: "Produto", desc: "Plano corporativo regulamentado pela ANS nÂº 489.120/21-8." },
];
...
export function QuotationPlanAccordions({ quotation, openAccordions, toggleAccordion }: QuotationPlanAccordionsProps) {
  ...
  const copartTitle = hasCoparticipation ? "Com coparticipaÃ§Ã£o" : "Sem coparticipaÃ§Ã£o";
  const copartDesc = hasCoparticipation
    ? "Possui custos adicionais reduzidos para a realizaÃ§Ã£o de consultas, exames simples, e procedimentos mÃ©dicos eletivos."
    : "NÃ£o possui custos adicionais para realizaÃ§Ã£o de consultas, exames, procedimentos ou internaÃ§Ãµes corporativas.";
